...
function realTimeLineChart() {
    ...
    var margin = {top: 10, right: 0, bottom: 30, left: 30},
        width = 1000,
        height = 600,
        duration = 500, // making this zero will creash it.
    ...
    function chart(selection) {
      ...
      selection.each(function(data) {
        ...
        y.domain([
          ...
          d3.max(data, function(c) { return d3.max(c.values, function(d) { return d.value * 1.5; })})
        ]);
        ...
        g.select("g.axis.x")
          ...
          .transition(t)
          .call(d3.axisBottom(x).ticks(10)); // controls number of ticks
        g.select("g.axis.y")
          .transition(t)
          .attr("class", "axis y")
          .call(d3.axisLeft(y));
        ...
        function tick() {
          ...
          d3.active(this)
              ...
              .transition()
              .on("start", tick); // not needed, use maybe for button
        }
      });
